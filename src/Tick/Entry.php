...
class Entry
{
     ...
     * @param string    $projectId      Project id where the entries belongs.
     ...
     * Create entry
     *
     * @param string    $taskId     Task id where the entry belongs.
     ...
     * @param string    $userId     User who create the entry.
     *
     * @return mixed
     */
